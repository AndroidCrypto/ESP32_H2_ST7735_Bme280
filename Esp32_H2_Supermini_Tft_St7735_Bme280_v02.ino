...
/*
Version Management
13.05.2025 V02 Pin changing, uses setCpuFrequency for changing the cpu frequency
23.04.2025 V01 Initial programming
*/

/*
TFT 128 x 160 pixels 1.8 inch ST7735 display wiring to an ESP32-H2 Supermini
...
const char *PROGRAM_VERSION = "ESP32-H2 Supermini ST7735 BME280 V02";
const char *PROGRAM_VERSION_SHORT = "ESP32H2 ST7735 BME280";
const char *DIVIDER = "--------------------";
